  ...
  return (
    <div className="relative min-h-screen flex flex-col md:flex-row items-center justify-center px-4 md:px-16 bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white overflow-hidden">
      ...
      <div className="relative z-10 w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left py-12 md:py-0 space-y-6 md:space-y-8 md:pr-5 lg:pr-10">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-300 via-blue-200 to-pink-300 bg-clip-text text-transparent">
          Jobs At Mobisoft Infotech
        </h1>
        <p className="text-base sm:text-lg md:text-xl text-gray-300/80 max-w-2xl leading-relaxed">
          ...
          {Array.from({ length: 10 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                boxShadow: `0 3px 12px rgba(128,0,255,0.6), 0 -2px 8px rgba(255,64,129,0.5)`,
                borderRadius: "8px",
      ...
      {/* Tagline Section */}
      <div className="absolute bottom-12 sm:bottom-16 left-1/2 transform -translate-x-1/2 w-full px-4 text-center">
        <br />
        <br />
        <p className="text-xl sm:text-lg md:text-xl lg:text-2xl font-semibold text-gray-300/80">
          Your Future Awaits: <span className="text-white font-bold text-3xl lg:text-purple-400">Step into Career Growth.</span>
        </p>
      </div>
