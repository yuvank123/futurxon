    ...
    <div className="relative w-full overflow-hidden py-24 px-4 md:px-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          variants={fadeUp}
        >
          <h1 className="text-4xl md:text-6xl unbounded-816 font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-white font-mono tracking-tighter">
            Our 6D Framework
          </h1>
