    ...
    <div className="min-h-screen py-8 md:py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex justify-center items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-16">
          <h1 className="text-3xl md:text-5xl xl:text-8xl font-bold font-mono tracking-tighter bg-gradient-to-r from-purple-800  via-blue-300 to-red-500 bg-clip-text text-transparent mb-4">
            Our Clients
          </h1>
        </div>
