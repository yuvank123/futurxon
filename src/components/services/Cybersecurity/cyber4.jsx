...
const CybersecurityTechnologyStack = () => {
  const categories = [
    {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Comprehensive cybersecurity solutions to protect your organization across cloud, endpoints, and networks.
          </p>
        </div>
...
export default CybersecurityTechnologyStack;
