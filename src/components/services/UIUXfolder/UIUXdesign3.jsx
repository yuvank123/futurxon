  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center px-4 py-20">
      ...
      <div className="relative z-10 text-center mb-16 max-w-4xl px-4">
        <h1 className="text-6xl font-bold font-mono tracking-tighter mb-6 bg-gradient-to-r from-purple-400 via-blue-400 to-red-400 bg-clip-text text-transparent">
