  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center px-4 py-20">
      ...
      <div className="relative z-10 text-center mb-2 md:mb-16 max-w-4xl px-4">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold font-mono tracking-tight mb-4 md:mb-6 bg-gradient-to-r from-purple-400 via-blue-400 to-red-400 bg-clip-text text-transparent">
      ...
      <div className="relative z-10 w-full px-2 sm:px-4 flex justify-center items-center">
        <img
          ...
          className="w-full h-auto max-w-3xl rounded-2xl shadow-lg"
        />
      </div>
    </div>
  );
